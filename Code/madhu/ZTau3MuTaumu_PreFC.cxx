...
void  ZTau3MuTaumu_PreFC::Configure(){
  ...
  Selection_Cut_mu_p_eta_before=HConfig.GetTH2D(Name+"_Selection_Cut_mu_p_eta_before","Selection_Cut_mu_p_eta_before",120,0.0,60.0,100,0,5.0,"#mu p_{T}, GeV","#mu |#eta|");
  Selection_Cut_mu_p_eta_after=HConfig.GetTH2D(Name+"_Selection_Cut_mu_p_eta_after","Selection_Cut_mu_p_eta_after",120,0.0,60.0,100,0,5.0,"#mu p_{T}, GeV","#mu |#eta|");
  Selection_Cut_mu_p_eta_after_reco=HConfig.GetTH2D(Name+"_Selection_Cut_mu_p_eta_after_reco","Selection_Cut_mu_p_eta_after_reco",120,0.0,60.0,100,0,5.0,"#mu p_{T}, GeV","#mu |#eta|");
  Selection_Cut_mu_p_eta_after_noreco=HConfig.GetTH2D(Name+"_Selection_Cut_mu_p_eta_after_noreco","Selection_Cut_mu_p_eta_after_noreco",120,0.0,60.0,100,0,5.0,"#mu p_{T}, GeV","#mu |#eta|");
  Selection_Cut_mu_p_eta_after_trigger=HConfig.GetTH2D(Name+"_Selection_Cut_mu_p_eta_after_trigger","Selection_Cut_mu_p_eta_after_trigger",120,0.0,60.0,100,0,5.0,"#mu p_{T}, GeV","#mu |#eta|");
  Selection_Cut_mu_p_eta_after_notrigger=HConfig.GetTH2D(Name+"_Selection_Cut_mu_p_eta_after_notrigger","Selection_Cut_mu_p_eta_after_notrigger",120,0.0,60.0,100,0,5.0,"#mu p_{T}, GeV","#mu |#eta|");
  
  Selection_Cut_Mu1_dR=HConfig.GetTH1D(Name+"_Selection_Cut_Mu1_dR","Selection_Cut_Mu1_dR",200,0,0.004,"#Delta R","Events");
  Selection_Cut_Mu2_dR=HConfig.GetTH1D(Name+"_Selection_Cut_Mu2_dR","Selection_Cut_Mu2_dR",200,0,0.004,"#Delta R","Events");
  Selection_Cut_Mu3_dR=HConfig.GetTH1D(Name+"_Selection_Cut_Mu3_dR","Selection_Cut_Mu3_dR",200,0,0.004,"#Delta R","Events");
  Selection_Cut_mu_dR=HConfig.GetTH1D(Name+"_Selection_Cut_mu_dR","Selection_Cut_mu_dR",200,0,0.004,"#Delta R","Events");
  Selection_Cut_Mu1_dR_large_scale=HConfig.GetTH1D(Name+"Selection_Cut_Mu1_dR_large_scale","Selection_Cut_Mu1_dR_large_scale",100,0,0.05,"#Delta R","Events");
  Selection_Cut_Mu2_dR_large_scale=HConfig.GetTH1D(Name+"Selection_Cut_Mu2_dR_large_scale","Selection_Cut_Mu2_dR_large_scale",100,0,0.05,"#Delta R","Events");
  Selection_Cut_Mu3_dR_large_scale=HConfig.GetTH1D(Name+"Selection_Cut_Mu3_dR_large_scale","Selection_Cut_Mu3_dR_large_scale",100,0,0.05,"#Delta R","Events");
  Selection_Cut_mu_dR_large_scale=HConfig.GetTH1D(Name+"Selection_Cut_mu_dR_large_scale","Selection_Cut_mu_dR_large_scale",100,0,0.05,"#Delta R","Events");
...
void  ZTau3MuTaumu_PreFC::Store_ExtraDist(){ 
  ...
  Extradist2d.push_back(&Selection_Cut_mu_p_eta_after_notrigger);
  ...
  if(id==210232){
          ...
          if(Whether_decay_found){
                  ...
                  */
                  ...
                  if(pass.at(Tau_mu_Candidate_p)&&pass.at(Tau_mu_Candidate_eta)&&pass.at(Tau_mu_Candidate_recod)&&(L1Ok&&HLTOk)){
                    Selection_Cut_mu_p_eta_after_trigger.at(t).Fill(Muon_LV.Pt(),abs(Muon_LV.Eta()));
                  }
                  if(pass.at(Tau_mu_Candidate_p)&&pass.at(Tau_mu_Candidate_eta)&&pass.at(Tau_mu_Candidate_recod)&&!(L1Ok&&HLTOk)){
                    Selection_Cut_mu_p_eta_after_notrigger.at(t).Fill(Muon_LV.Pt(),abs(Muon_LV.Eta()));
                  }
